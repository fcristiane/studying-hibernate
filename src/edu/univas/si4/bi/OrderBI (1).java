...
import edu.univas.si4.entity.Client;
...
public class OrderBI {
	...
	public static void createOrder(Client client, ArrayList<Item> items) throws OrderException {
		try {
			...
			order.setClientCode(client.getCode());
